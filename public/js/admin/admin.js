...
__webpack_require__(/*! ./common/bootstrap */ "./resources/js/admin/common/bootstrap.js"); // Load view file.


__webpack_require__(/*! ../common/View.js */ "./resources/js/common/View.js"); // Init Common & load the default functions.


(window['Common'] = __webpack_require__(/*! ./common/load.js */ "./resources/js/admin/common/load.js")).init(); // Auto load views.


_common_AutoloadViews__WEBPACK_IMPORTED_MODULE_0__["default"].load('../admin', __webpack_require__("./resources/js/admin sync recursive .(js%7Cvue)$"));

/***/ }),

/***/ "./resources/js/admin/common/bootstrap.js":
/*!************************************************!*\
  !*** ./resources/js/admin/common/bootstrap.js ***!
  \************************************************/
...
/***/ "./resources/js/admin/common/load.js":
/*!*******************************************!*\
  !*** ./resources/js/admin/common/load.js ***!
  \*******************************************/
/***/ ((module) => {
...
/***/ "./resources/js/admin/modules/administrator/createEdit.js":
/*!****************************************************************!*\
  !*** ./resources/js/admin/modules/administrator/createEdit.js ***!
  \****************************************************************/
/***/ (() => {
...
common.View.create('admin.modules.administrator.CreateEdit', {
  ...
  changeUserInput: function changeUserInput() {
...
/***/ "./resources/js/admin/modules/dashboard/index.js":
/*!*******************************************************!*\
  !*** ./resources/js/admin/modules/dashboard/index.js ***!
  \*******************************************************/
/***/ (() => {
...
/***/ "./resources/js/admin/modules/page/createEdit.js":
/*!*******************************************************!*\
  !*** ./resources/js/admin/modules/page/createEdit.js ***!
  \*******************************************************/
/***/ (() => {
...
common.View.create('admin.modules.page.CreateEdit', {
  ...
  initCloneScript: function initCloneScript() {
    (function ($) {
      $.fn.cloneData = function (options, callback) {
        ...
        var _addItem = function _addItem() {
          ...
          var item_exists = $('.' + settings.cloneContainer).length; // stop append HTML if maximum limit exceed
          ...
          _updateAttributes(); // afterRender.apply(this, Array.prototype.slice.call(arguments, 1));
        ...
        var _updateAttributes = function _updateAttributes() {
        ...
        var _updateAttrID = function _updateAttrID($elem, index) {
        ...
        var _incrementLastNumber = function _incrementLastNumber(string, index) {
          return string.replace(/[0-9]+(?!.*[0-9])/, function (match) {
            return index;
          });
        };

        var _updateAttrName = function _updateAttrName($elem, index) {
        ...
        var _parseTemplate = function _parseTemplate() {
          ...
          var $template = $(template_clone).clone(false, false); //console.log($template);
          ...
          $template.find('.select2-container').remove(); //Remove Elements with excludeHTML
        ...
        var _initializePlugins = function _initializePlugins() {
        ...
        var _deleteItem = function _deleteItem($elem) {
          var count = _count();
...
/***/ "./resources/js/admin/modules/page/index.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/modules/page/index.js ***!
  \**************************************************/
/***/ (() => {
...
/***/ "./resources/js/admin/modules/social/index.js":
/*!****************************************************!*\
  !*** ./resources/js/admin/modules/social/index.js ***!
  \****************************************************/
/***/ (() => {
...
/***/ "./resources/js/admin sync recursive .(js%7Cvue)$":
/*!***********************************************!*\
  !*** ./resources/js/admin/ sync .(js%7Cvue)$ ***!
  \***********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var map = {
	"./admin.js": "./resources/js/admin/admin.js",
	"./common/bootstrap.js": "./resources/js/admin/common/bootstrap.js",
	"./common/load.js": "./resources/js/admin/common/load.js",
	"./modules/administrator/createEdit.js": "./resources/js/admin/modules/administrator/createEdit.js",
	"./modules/dashboard/index.js": "./resources/js/admin/modules/dashboard/index.js",
	"./modules/page/createEdit.js": "./resources/js/admin/modules/page/createEdit.js",
	"./modules/page/index.js": "./resources/js/admin/modules/page/index.js",
	"./modules/social/index.js": "./resources/js/admin/modules/social/index.js"
};
...
webpackContext.id = "./resources/js/admin sync recursive .(js%7Cvue)$";
