@section('meta')
<title>{{ config('app.name') }} | {{ __('Clients') }}</title>
    <meta name="description" content="{{ __('Clients Description') }}" />
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
                    ...
                    @include('admin.layouts.breadcrumb', [
                        'title' => __('Clients'),
                        'description' => __('Clients Description'),
                        'breadcrum' => [
                            __('Clients') => '#',
                        ],
                    ])
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        @can('modules.client.add')

                                        <div class="col-md-12 d-flex justify-content-end mb-4">

                                            <a href="{{ route('client.create') }}" class="btn btn-primary">{{ __('Client') }} {{ strtolower(__('Add')) }}</a>
